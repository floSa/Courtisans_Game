...
| Prochaine action | **Lancer la phase 3.** Le prompt de construction est écrit : [prompts/10_phase3_construction.md](prompts/10_phase3_construction.md), à coller dans la **conversation n° 6**. Le prompt d'audit s'écrira quand le compte rendu du constructeur existera, pour la **conversation n° 7** |
