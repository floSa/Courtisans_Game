...
| Prochaine action | **Lancer la phase 4, itération 1.** Le prompt de construction est écrit : [prompts/18_phase4_iteration_1.md](prompts/18_phase4_iteration_1.md), à coller dans une conversation **neuve, n° 8**. L'audit sera la n° 9. *(Ancienne formulation : « écrire les prompts de la phase 4.* Premier travail : **étendre le périmètre des mutations** à `mesure/` et au reste de `agents/`, `agents/greedy.py` excepté. Puis le premier levier : **la tête de valeur**, pas le budget |
