...
| Prochaine action | **Écrire les prompts de la phase 4.** Premier travail : **étendre le périmètre des mutations** à `mesure/` et au reste de `agents/`, `agents/greedy.py` excepté. Puis le premier levier : **la tête de valeur**, pas le budget |
